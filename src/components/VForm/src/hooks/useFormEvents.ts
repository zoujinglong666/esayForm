...
import type { Recordable } from '@/hooks/vben/types'
...
export function useFormEvents({
  ...
  async function validateFields(nameList?: any[] | undefined) {
  ...
  async function validate(nameList?: any[] | false | undefined) {
    let _nameList: any
    ...
    const res = await unref(formElRef)?.validate((res) => {})
    if (res) {
