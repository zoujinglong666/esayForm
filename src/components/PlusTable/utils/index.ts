...
import type { FieldValueType, RecordType, PlusColumn } from '@/components/PlusTable/types'
import { get, set } from 'lodash-es'
import type { SetupContext } from 'vue'
import { isRef, unref } from 'vue'
import { isFunction, isPlainObject, isEmptyObject, isString, isBoolean, isObject } from '@/utils/is'
...
const throwError = (data: any, type: string) => {
  if (!isPlainObject(data)) {
    throw new Error(`${type} expected Object but got}`)
  }
}
